...
| 4 | **JPG↔PDF + OCR + Passwords** — JPG→PDF & PDF→JPG; Tesseract.js worker (lazy-loaded languages, English+Hindi); password add/remove via @cantoo/pdf-lib | 8–10 hrs | Full feature parity with SmallPDF free tier | ✅ **Complete** (2026-05-17) |
| 5 | **Programmatic SEO scale-up** — Astro content collection driving 60+ landing pages (12 ops × size variants × India intents); JSON-LD (SoftwareApplication, FAQPage, HowTo); sitemap; internal link graph; blog scaffold | 6–8 hrs | 68 pages, 68 sitemap URLs, 5 JSON-LD types per page | ✅ **Complete** (2026-05-17) |
