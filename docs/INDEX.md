...
| 3 | **Compression pipeline** — canvas + mozjpeg-wasm worker chain; binary-search size targeting; India presets (100/200/500 KB, 1/2 MB); ghostscript-wasm fallback | 10–12 hrs | One-click "Compress to 200 KB for SSC" working | 🔜 **Next** |
