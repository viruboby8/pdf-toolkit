...
| # | Phase | Session time | Ships |
|---|-------|--------------|-------|
| 1 | **Foundation** — Astro+Svelte scaffold, merge+split+rotate via pdf-lib, drag/drop UI, basic PWA, Cloudflare Pages deploy, MIT-licensed public GitHub repo, base SEO | 8–10 hrs | Live URL with three working tools, repo public |
| 2 | **Workers + OPFS architecture** — reorder, delete, extract pages; Web Worker + Comlink RPC; OPFS streaming for 100MB+ PDFs; pdfjs-dist thumbnails; progress bars | 8–10 hrs | Handles 300MB PDFs without freezing; the interview piece |
| 3 | **Compression pipeline** — canvas + mozjpeg-wasm worker chain; binary-search size targeting; India presets (100/200/500 KB, 1/2 MB); ghostscript-wasm fallback | 10–12 hrs | One-click "Compress to 200 KB for SSC" working |
| 4 | **JPG↔PDF + OCR + Passwords** — JPG→PDF & PDF→JPG; Tesseract.js worker (lazy-loaded languages, English+Hindi); password add/remove via @cantoo/pdf-lib | 8–10 hrs | Full feature parity with SmallPDF free tier |
